...
<div class="container" style="width: 90%;">
    ...
    <%--<c:if test="${sessionScope.identity_id ne 4}">--%>
        ...
        <div class="form table">
            <div>
                <form class="layui-form form-inline" action="${pageContext.request.contextPath}/article/findByPage.do" role="form" method="post">
    ...
    <%--<c:if test="${sessionScope.identity_id ne 4}">--%>
        <div class="layui-inline">
            ...
            <%--添加文章 跳转到添加文章页面--%>
            <a href="${pageContext.request.contextPath}/article/toArticleWrite.do"><button type="button" id="addBtn" class="layui-btn layui-btn">添加文章</button></a>
        </div>
    <%--</c:if>--%>
    <br/>
    <br/>
    <div class="table-responsive">
        <table class="table table-striped table-hover" id="countTable">
            ...
            <thead>
            <tr>
                <th style="text-align: center"><input type="checkbox" id="all" onclick="selectAll()"/></th>
            ...
            <c:forEach items="${requestScope.page.beanList}" var="article">
                <tr>
                    ...
                    <%--查看  编辑  删除--%>
                    <td>
                        <a href="${pageContext.request.contextPath}/article/toArticleView.do?r_id=${article.r_id}"><button type="button" class="layui-btn layui-btn-sm">查看</button></a>
                        <a href="${pageContext.request.contextPath}/article/toEditPage.do?r_id=${article.r_id}"><button type="button" class="layui-btn layui-btn-sm layui-btn-normal">编辑</button></a>
                    ...
                    <td>
                        <a href="${pageContext.request.contextPath}/article/toArticleView.do?r_id=${article.r_id}"><button type="button" class="layui-btn layui-btn-sm">查看文章</button></a>
                    </td>
                    <%--</c:if>--%>
                </tr>
            </c:forEach>
    ...
    <form class="listForm" name="listForm" method="post" action="${pageContext.request.contextPath}/article/findByPage.do">
        <div class="row">
            <div class="form-inline" style="margin-left: 15px;">
                ...
                <ul class="pagination" style="float:right;">
                    <li>
                        <a href="${pageContext.request.contextPath}/article/findByPage.do?pageCode=1"><strong>首页</strong></a>
                    </li>
                    <li>
                        <c:if test="${requestScope.page.pageCode > 2}">
                            <a href="${pageContext.request.contextPath}/article/findByPage.do?pageCode=${requestScope.page.pageCode - 1}">&laquo;</a>
                        </c:if>
                    </li>
                    ...
                    <c:forEach var="i" begin="${begin}" end="${end}">
                        ...
                        <c:if test="${i != requestScope.page.pageCode}">
                            <li>
                                <a href="${pageContext.request.contextPath}/article/findByPage.do?pageCode=${i}">${i}</a>
                            </li>
                        </c:if>
                    </c:forEach>
                    ...
                    <li>
                        <c:if test="${requestScope.page.pageCode < requestScope.page.totalPage}">
                            <a href="${pageContext.request.contextPath}/article/findByPage.do?pageCode=${requestScope.page.pageCode + 1}">&raquo;</a>
                        </c:if>
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/article/findByPage.do?pageCode=${requestScope.page.totalPage}"><strong>末页</strong></a>
                    </li>
                </ul>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function clean(r_id){
        layer.open({
            ...
            btn1: function(index,layero){
                $.ajax({
                    url: '${pageContext.request.contextPath}/article/clean.do',
                    type: 'POST',
                    data: {r_id: r_id},
    ...
    function edit(r_id){
        $.ajax({
            url: '${pageContext.request.contextPath}/article/toEditPage.do',
            type: 'GET',
            data: {r_id: r_id},
            success: function(data){
                $("body").html(data);
    ...
    function selectAll() {
        ...
        var r_id = document.getElementsByClassName("r_id");
        console.log(r_id);
        for (var i = 0; i < r_id.length; i++) {
            r_id[i].checked = all.checked;
        }
    }

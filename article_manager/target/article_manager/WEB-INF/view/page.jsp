...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-left">
            ...
            <%--跳转到首页面--%>
            <li class="layui-nav-item"><a href="${pageContext.request.contextPath}/admin/page.do" style="text-decoration: none;"><strong>首页</strong></a></li>
        </ul>
        <ul class="layui-nav layui-layout-right">
            <li class="layui-nav-item">
                <a href="javascript:;" style="text-decoration: none;">
                    ...
                    <%--头像--%>
                    <img src="${pageContext.request.contextPath}/static/img/avatar.jpg" class="layui-nav-img">
                ...
                <dl class="layui-nav-child">
                    ...
                    <%--退出登录--%>
                    <dd><a href="${pageContext.request.contextPath}/admin/outLogin.do" style="text-decoration: none;;"><strong>退出登录</strong></a></dd>
                </dl>
            </li>
            <li class="layui-nav-item">
            ...
            <%--退出登录--%>
            <li class="layui-nav-item"><a href="${pageContext.request.contextPath}/admin/outLogin.do" style="text-decoration: none;;"><strong>退出</strong></a></li>
        </ul>
    </div>
...
<script type="text/javascript">
    function toArticleManage() {
        document.getElementById("content").innerHTML = "<object type=\"text/html\" data=\"${pageContext.request.contextPath}/article/toArticleManage.do\" width=\"100%\" height=\"100%\"></object>";
    }
    function toArticleWrite() {
        document.getElementById("content").innerHTML = "<object type=\"text/html\" data=\"${pageContext.request.contextPath}/article/toArticleWrite.do\" width=\"100%\" height=\"100%\"></object>";
    }
    function toArticleTrash() {
        document.getElementById("content").innerHTML = "<object type=\"text/html\" data=\"${pageContext.request.contextPath}/article/toArticleTrash.do\" width=\"100%\" height=\"100%\"></object>";
    }
</script>
</html>
...
<head>
    ...
    <style type="text/css" h>
        .header{
            background-image: url("${pageContext.request.contextPath}/static/img/color.jpeg");
            background-size: 100%;
            height: 240px;
        }
        #code{
...
<div class="container">
    <div id="content">
        ...
        <!-- 登录的表单 -->
        <form action="${pageContext.request.contextPath}/admin/login.do" id="loginform" method="post" class="layui-form" style="text-align: center;margin-right:12%;margin-top:10%;">
            <%--??--%>
            ...
            <div>
                <div class="layui-form-item layui-inline" style="width:110%">
                    ...
                    <div class="layui-input-inline">
                        ...
                        <%--登录账户--%>
                        <input type="text" name="a_name" class="layui-input" style="background:none;border: none;border-bottom:1px solid white;" placeholder="请输入登录账号"/>
                    </div>
                </div>
                ...
                <div class="layui-form-item layui-inline">
                    ...
                    <div class="layui-input-inline">
                        ...
                        <%--登录密码--%>
                        <input type="password" name="a_password" class="layui-input" style="background:none;border: none;border-bottom:1px solid white;" placeholder="请输入密码"/>
                    </div>
                </div>
                <br/>
                <br/>
        ...
        <!-- 注册的表单 -->
        <form action="${pageContext.request.contextPath}/admin/register.do" id="registerform" method="post" class="layui-form" hidden="hidden" style="text-align: center;margin-right:12%;margin-top:10%;">
            <div>
                <div class="layui-form-item layui-inline" style="width:110%">
                    <label class="layui-form-label" style="margin-left:13%;"><i class="fa fa-user fa-fw"></i></label>
                    <div class="layui-input-inline">
                        ...
                        <%--注册账号， 离焦触发事件--%>
                        <input type="text" name="a_name" id="a_name" onblur="return checkName();" class="layui-input" style="background:none;border: none;border-bottom:1px solid white;" placeholder="请输入账号"/>
                    </div>
                    <span id="info"></span>
                </div>
                <br/>
                <div class="layui-form-item layui-inline">
                    ...
                    <div class="layui-input-inline">
                        ...
                        <%--输入密码--%>
                        <input type="password" name="a_password" id="a_password" class="layui-input" style="background:none;border: none;border-bottom:1px solid white;" placeholder="请输入密码"/>
                    </div>
                </div>
                <br/>
...
<script type="text/javascript">
    ...
    function checkName(){
        ...
        if(a_name != ''){
            $.ajax({
                type: 'post',
                url: '${pageContext.request.contextPath}/admin/findByName.do',
